...
CCmd
ccmd_create (int argc, char* argv[])
{
  if (argc <= 1)
    {
      ccmd_on_help (NULL);
  ...
  struct
  {
    ...
    { "init", ccmd_on_init }, { "build", ccmd_on_build },
    { "run", ccmd_on_run },   { "test", ccmd_on_test },
    { "doc", ccmd_on_doc },   { "fmt", ccmd_on_fmt },
    { "help", ccmd_on_help }, { "version", ccmd_on_version },
  };
...
void
ccmd_on_init (CCmd* self)
{
}

void
ccmd_on_build (CCmd* self)
{
  (void) self;
...
void
ccmd_on_run (CCmd* self)
{
}

void
ccmd_on_test (CCmd* self)
{
}

void
ccmd_on_doc (CCmd* self)
{
}

void
ccmd_on_fmt (CCmd* self)
{
}

void
ccmd_on_help (CCmd* self)
{
  (void) self;
